...
```{r}
#| label: fig-glycolysis-violin
#| fig-cap: "各细胞类型糖酵解活性比较 — 恶性导管细胞得分最高"
#| eval: true
#| message: false
#| warning: false
...
```{r}
#| label: fig-ductal-compare
#| fig-cap: "恶性 vs 良性导管细胞糖酵解活性"
#| eval: true
#| message: false
#| warning: false
