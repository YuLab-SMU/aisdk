...
AI models often output unstructured text. `generate_object()` forces the model to return data that matches a specific schema, making it safe for programmatic use.
...
**aisdk** includes a special `z_dataframe()` helper that requests a list of objects, which is perfect for extracting tables.
