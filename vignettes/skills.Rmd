...
The Skill System allows you to package R scripts and instructions into reusable units that agents can load dynamically.

## Structure of a Skill

A skill is a directory containing:
- `SKILL.md`: Metadata (YAML header) and instructions.
- `scripts/`: R scripts that can be executed.
