  ...
  use_max_completion_tokens = FALSE
    ...
    CustomProvider <- R6::R6Class(
        ...
        public = list(
            ...
            #' @description Get a Language Model instance for this custom provider.
            #' @param model_id The specific model to use (e.g. "gpt-4o")
            #' @return A LanguageModelV1 object instance.
